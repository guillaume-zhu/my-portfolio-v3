...
import homeLoaderVertexShader from "../../shaders/homeLoader/vertex.glsl"
import homeLoaderFragmentShader from "../../shaders/homeLoader/fragment.glsl"
...
export const createHomeLoader = ({ enabled = true, minimumDuration = 1.2 } = {}) => {
  ...
  const ready = (async () => {
    try {
      logoTexture = await new THREE.TextureLoader().loadAsync("/logo-guillaume-zhu.svg")
